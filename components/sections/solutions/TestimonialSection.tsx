      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            >
              <svg
                className="h-20 w-20 text-[#c58d12]/40"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#c58d12]/20 bg-linear-to-br from-zinc-900/70 via-black/70 to-black/80 p-8 transition-all duration-500 hover:border-[#c58d12]/40 lg:p-12">
            ...
            <motion.div
              className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-linear-to-bl from-[#c58d12]/20 to-transparent blur-3xl opacity-40 transition-opacity duration-500"
            ...
            >
              <motion.div
                ...
                className="relative"
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#d4a24a]/50 bg-linear-to-br from-[#c58d12] via-[#d4a24a] to-[#c58d12] text-lg font-bold text-black shadow-lg">
                  {author
                    .split(" ")
                    .map((name) => name[0] ?? "")
                    .join("")}
            ...
            <motion.div
              className="pointer-events-none absolute bottom-0 right-0 h-40 w-40 rounded-tl-full bg-linear-to-tl from-[#c58d12]/15 to-transparent"
