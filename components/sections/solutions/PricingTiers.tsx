      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-3 lg:gap-6">
          {tiers.map((tier, index) => {
            ...
            const cardGlow =
              "absolute -inset-1 rounded-3xl bg-linear-to-r from-[#c58d12]/40 via-[#d4a24a]/30 to-[#c58d12]/40 blur-3xl";
              ...
              >
                {isHighlighted && (
                  <motion.div
                    ...
                    animate={{
                      opacity:
                        hoveredIndex === index ? [0.25, 0.5, 0.25] : 0.25,
                    }}
                    transition={{
                      duration: 3,
                      repeat: Infinity,
                ...
                >
                  {tier.badge && (
                    ...
                    >
                      <div className="flex items-center gap-2 rounded-full bg-linear-to-r from-[#c58d12] via-[#d4a24a] to-[#c58d12] px-5 py-2 text-xs font-bold uppercase text-black shadow-[0_0_30px_rgba(197,141,18,0.45)]">
                        <svg
                          className="h-4 w-4"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                  ...
                  >
                    <div
                      className={`pointer-events-none absolute inset-0 rounded-xl blur transition opacity-0 ${hoveredIndex === index ? "opacity-100" : ""} ${
                        isHighlighted
                          ? "bg-linear-to-r from-[#c58d12]/20 to-[#d4a24a]/20"
                          : "bg-linear-to-r from-[#c58d12]/10 to-transparent"
                      }`}
                    />
                    <Link
                      href="/#contact"
