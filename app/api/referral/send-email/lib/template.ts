    ...
    <div style="max-width:650px;margin:0 auto;background:#ffffff;border-radius:16px;box-shadow:0 20px 25px -5px rgba(0,0,0,0.1),0 10px 10px -5px rgba(0,0,0,0.04);overflow:hidden;border:1px solid rgba(148,163,184,0.2);">
      ...
      <div style="padding:40px 30px;">
        <div style="text-align:center;margin-bottom:32px;">
          <p style="color:#1e293b;font-size:17px;line-height:1.6;margin:0 0 14px 0;">Hallo <span style="color:#6366f1;font-weight:600;">${firstName} ${lastName}</span> 👋</p>
        ...
        <div style="text-align:center;margin:0 auto 30px auto;max-width:400px;background:linear-gradient(135deg,#eef2ff,#ede9fe);padding:22px 24px;border:1px solid #c7d2fe;border-radius:14px;">
          ...
          <div style="font-size:30px;font-weight:700;letter-spacing:3px;color:#312e81;font-family:monospace;">${referralCode}</div>
        ...
        <div style="background:linear-gradient(135deg,#f8fafc,#f1f5f9);border:1px solid #e2e8f0;border-radius:14px;padding:26px 24px;margin-bottom:32px;">
          ...
          <p style="margin:0 0 8px 0;color:#334155;line-height:1.6;">Projektpreis: <strong>€${referrerPrice.toFixed(2)}</strong></p>
          <p style="margin:0;color:#334155;line-height:1.6;">Empfehlungen gesammelt: <strong>${referralCount}</strong> ${hasReachedMaximum ? '<span style="color:#065f46;font-weight:600;">(Maximum erreicht 🎉)</span>' : ""}</p>
        </div>
