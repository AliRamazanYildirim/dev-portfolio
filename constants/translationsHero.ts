...
export type HeroTranslationsMap = typeof heroTranslations;
export type HeroLocale = keyof HeroTranslationsMap;
export type HeroDictionary = HeroTranslationsMap[HeroLocale];
export type HeroProcessModalContent = NonNullable<HeroDictionary["processModal"]>;
